...
google.maps.event.addListenerOnce(map, 'tilesloaded', function () {
    ...
    var BuildingsOverlay = new google.maps.KmlLayer(
            'http://search.missouristate.edu/map/kml/?layers=base&format=basic',
             KmlOptions);
...
// The geolocation marker code below is open source and part of the Google Maps API v3 Utility Library
